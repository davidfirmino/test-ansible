#!/usr/bin/env bash
# io_analyzer_pro.sh - High-Precision Tail Analysis (Pure Integer Version)
...
echo "=== IO TAIL ANALYZER v10.2 (Pure Integer) ==="
...
END {
    ...
    if (@w_total > 0) {
        ...
        printf("    >  1 ms  : %-10d (%d.%02d%%)\n", @w_tail_gt1, (@w_tail_gt1 * 10000 / @w_total) / 100, (@w_tail_gt1 * 10000 / @w_total) % 100);
