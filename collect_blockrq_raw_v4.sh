...
COLLECTOR_PY="${COLLECTOR_PY:-${SCRIPT_DIR}/collect_blockrq_raw_v2.py}"
PYTHON_BIN="${PYTHON_BIN:-python3}"

usage() {
    cat <<'EOF'
Usage: collect_blockrq_raw_v2.sh [options]
...
Options:
  ...
  --collector <path>    Path to collect_blockrq_raw_v2.py
...
echo "[*] Starting block_rq_* capture for device $DEV ..."
